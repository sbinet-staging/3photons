...
__host__ unsigned int lfsr113_sse_generate_(lfsr113_sse_state* state){ // here SSE4 instruction pblendw is used
  unsigned output;
...
__device__ __host__ unsigned lfsr113_SkipAheadRoundSingleBit(unsigned state,unsigned bit,unsigned p,unsigned q,unsigned s,int n){
...
__device__ __host__ unsigned lfsr113_SkipAheadRoundSingle(unsigned state,unsigned p,unsigned q,unsigned s,int n){
  char arr0[64]; char arr[128][32];                              // this function skips ahead 2^n*s bits
...
__device__ __host__ void lfsr113_SkipAheadRound(lfsr113_state* state,int n){ // Skips Ahead 2^n
...
__host__ void lfsr113_generate_gpu_array_(lfsr113_state* state, unsigned int* dev_out, long length){
...
__host__ void lfsr113_generate_gpu_array_float_(lfsr113_state* state, float* dev_out, long length){
...
__host__ void lfsr113_generate_gpu_array_double_(lfsr113_state* state, double* dev_out, long length){
