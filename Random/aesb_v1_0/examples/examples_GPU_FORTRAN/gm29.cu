...
extern "C" __host__ unsigned int gm29_sse_generate_(gm29_sse_state* state){
...
extern "C" __device__ __host__ void gm29_get_sse_state_(gm29_state* state,gm29_sse_state* sse_state){
  int i; for(i=0;i<32;i++) {sse_state->xN[i]=state->xN[i]; sse_state->xP[i]=state->xP[i];}
}

extern "C" __device__ __host__ unsigned gm29_CNext(unsigned N,unsigned P){
  return (gm29_k*N+gm29_q*(gm29_g-P))%gm29_g;
}

extern "C" __device__ __host__ unsigned gm29_CNext2(unsigned N,unsigned P,unsigned myk,unsigned myq){
...
extern "C" __device__ __host__ unsigned gm29_GetNextN(unsigned x0,unsigned x1,unsigned n){ //returns x_{2^n}
...
extern "C" __device__ __host__ unsigned gm29_GetNextAny(unsigned x0,unsigned x1,unsigned long long N){ // returns x_N
...
extern "C" __device__ __host__ void gm29_skipahead_(gm29_state* state, unsigned long long offset){
  unsigned xn,xp,j; 
  for(j=0;j<32;j++){
...
extern "C" __device__ __host__ void gm29_init_(gm29_state* state){
...
extern "C" __device__ __host__ void gm29_init_short_sequence_(gm29_state* state,unsigned SequenceNumber){
...
extern "C" __device__ __host__ void gm29_init_medium_sequence_(gm29_state* state,unsigned SequenceNumber){
...
extern "C" __device__ __host__ void gm29_init_long_sequence_(gm29_state* state,unsigned SequenceNumber){
...
extern "C" __device__ __host__ unsigned int gm29_generate_(gm29_state* state){
...
extern "C" __device__ __host__ float gm29_generate_uniform_float_(gm29_state* state){
  unsigned sum=0, i, temp,bit=1;
  for(i=0;i<32;i++){ 
    temp=(gm29_k*state->xN[i]+gm29_q*(gm29_g-state->xP[i]))%gm29_g;
    state->xP[i]=state->xN[i]; state->xN[i]=temp;
...
extern "C" __host__ void gm29_print_state_(gm29_state* state){int i;
...
extern "C" __host__ void gm29_print_sse_state_(gm29_sse_state* state){int i;
    printf("Generator State:\nxN={");
    for(i=0;i<32;i++) {printf("%u",state->xN[i]%gm29_g); printf((i<31)?",":"}\nxP={");}
    for(i=0;i<32;i++) {printf("%u",state->xP[i]%gm29_g); printf((i<31)?",":"}\n\n");}
}
...
extern "C" __host__ void gm29_generate_gpu_array_(gm29_state* state, unsigned int* dev_out, unsigned int* length){
...
extern "C" __host__ void gm29_generate_gpu_array_float_(gm29_state* state, float* dev_out, unsigned int* length){
...
extern "C" __host__ void gm29_generate_gpu_array_double_(gm29_state* state, double* dev_out, unsigned int* length){
...
extern "C" __host__ void gm29_generate_array_(gm29_state* state, unsigned int* out, unsigned int* length){
