...
C----------------------------------------------------------------------
      ...
      CALL HBOOK1(210,'QED:Angle photons 1 et 2',NBIN,-UN,UN,0.)
      CALL HBOOK1(220,'QED:Angle photons 1 et 3',NBIN,-UN,UN,0.)
      CALL HBOOK1(230,'QED:Angle photons 2 et 3',NBIN,-UN,UN,0.)
      ...
      CALL HBOOK1(211,'B+ :Angle photons 1 et 2',NBIN,-UN,UN,0.)
      CALL HBOOK1(221,'B+ :Angle photons 1 et 3',NBIN,-UN,UN,0.)
      CALL HBOOK1(231,'B+ :Angle photons 2 et 3',NBIN,-UN,UN,0.)
      ...
      CALL HBOOK1(291,'B+ :Energie du photon 3',NBIN,0.E0,E3,0.E0)
      CALL HBOOK1(296,'B+ : Angle normale et l axe',NBIN,0.E0,UN,0.)

      CALL HBOOK1(202,'B- :Acolinearite photons 1 et 2',NBIN,-UN,UN,0.)
      CALL HBOOK1(212,'B- :Angle photons 1 et 2',NBIN,-UN,UN,0.)
      CALL HBOOK1(222,'B- :Angle photons 1 et 3',NBIN,-UN,UN,0.)
      CALL HBOOK1(232,'B- :Angle photons 2 et 3',NBIN,-UN,UN,0.)
      ...
      CALL HBOOK1(292,'B- :Energie du photon 3',NBIN,0.E0,E3,0.E0)
      CALL HBOOK1(297,'B- : Angle normale et l axe',NBIN,0.E0,UN,0.)
...
C----------------------------------------------------------------------
C
C Effectue la normalisation supplementaire des histogrammes 
C
C----------------------------------------------------------------------
      IMPLICIT NONE
      REAL*8 ETOT,C0,C1,C2
      REAL*4 W0,W1,W2,ZERO,UN,D
      REAL*4 E2,E3,E4,D1,D2,D3,Q
      PARAMETER (ZERO=0.E0,UN=1.E0,D=2.E0)
      INCLUDE 'paw.i'
      ...
      CALL HOPERA(220,'+',220,220,W0/D,ZERO)
      CALL HOPERA(230,'+',230,230,W0/D,ZERO)
      ...
      CALL HOPERA(221,'+',221,221,W1/D,ZERO)
      CALL HOPERA(231,'+',231,231,W1/D,ZERO)
      ...
      CALL HOPERA(222,'+',222,222,W2/D,ZERO)
      CALL HOPERA(232,'+',232,232,W2/D,ZERO)
